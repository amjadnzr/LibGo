...
export default class ViewCard extends React.Component<{items:any,viewClick:any,deleteClick:any}> {
      ...
      <div key={index} className="view-card-container">
        ...
        <div className="view-card-unavailable-tag">Unavailable</div>
          ...
          <div className="view-card-button-container">
              <button id="view-card-view-button" onClick={this.props.viewClick.bind(this.props,index)}>View</button>
              <button id="view-card-delete-button" onClick={this.props.deleteClick.bind(this.props,index)}>Delete</button>
          </div>
          </div>
      </div>
        ) })}
