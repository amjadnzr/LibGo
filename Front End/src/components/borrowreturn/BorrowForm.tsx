...
export default function BorrowForm(props:any) {
  ...
  return (
    ...
    <div className="input-container">
        <input className="input-box" type="text" name="rname" placeholder="Reader Name" />
        <small className="form-input-error">{props.err.rname}</small>
    </div>

    <div className="input-container">    
        <input className="input-box" type="email"name="rmail" placeholder="Reader Email"  />
    ...
    <div className="input-container">    
        <input className="input-box" type="text" name="rmobile" placeholder="Reader Mobile" />
